    ...
    <section className='bg-gradient-to-b from-blue-900 to-blue-950'>
        ...
        <div className='max-w-[1320px] mx-auto px-10 md:flex-row flex-col py-20'>
            ...
            <div className='flex flex-wrap justify-center'>
                ...
                <p className='text-[rgba(255,255,255,0.6)] w-[780px] pt-[20px]'>With over 25 years of experience, we have crafted thousands of strategic discovery process  that enables us to peel back the layers which enable us to understand.</p>
